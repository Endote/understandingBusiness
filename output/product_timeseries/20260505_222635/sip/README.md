# SIP soldqty time-series analysis
...
- `products_with_negative_soldqty`: 2270
- `max_raw_reconstruction_abs_error`: 9.094947017729282e-13
- `max_nonnegative_reconstruction_abs_error`: 9.094947017729282e-13
- `max_drawqty_reconstruction_abs_error`: 3.637978807091713e-12

## Fact quality

- `fact_rows`: 10890176
- `fact_products`: 3236
- `total_soldqty_raw`: 4989173
- `total_soldqty_nonnegative`: 5000399
- `total_drawqty`: 38694187
- `negative_soldqty_rows`: 7634
- `zero_soldqty_rows`: 8376931
- `stockout_proxy_rows`: 270895
- `aggregate_sellthrough_raw`: 0.1289385664053363
- `aggregate_sellthrough_nonnegative`: 0.1292286875028541
